...
namespace WebApplication2.Services.Interfaces
{
    ...
    {
        Task<IReadOnlyList<TarifaAdmisionDto>> ListarTarifasAsync(bool? soloActivas = null, CancellationToken ct = default);
        ...
        Task<GenerarRecibosAdmisionResultDto> GenerarRecibosAsync(int idAspirante, int idTarifaAdmision, bool pagoCompleto, CancellationToken ct = default);
